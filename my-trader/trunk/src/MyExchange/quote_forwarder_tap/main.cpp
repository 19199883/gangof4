...
typedef quote_source<quote_src_types::tap,TapAPIQuoteWhole_MY> QuoteSourceT;
typedef forwarder<TapAPIQuoteWhole_MY> forwarderT1;
...
int main(int argc, char  *argv[]) {
	...
	forwarderT1 *forwarder1= new forwarderT1(setting.forwarders["TapAPIQuoteWhole"]);

	quote_sourceInc = new QuoteSourceT(setting.MarketdataConfig,setting.Subscription,forwarder1,
			(forwarder<int>*)NULL,(forwarder<int>*)NULL,(forwarder<int>*)NULL,(forwarder<int>*)NULL,(forwarder<int>*)NULL);
