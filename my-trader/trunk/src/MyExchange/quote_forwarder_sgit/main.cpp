...
typedef quote_source<quote_src_types::sgit,SGIT_Depth_Market_Data_Field> QuoteSourceT;
...
int main() {
	...
	forwarder<SGIT_Depth_Market_Data_Field> *forwarder1= new forwarder<SGIT_Depth_Market_Data_Field>(setting.forwarders["SGIT_Depth_Market_Data_Field"]);
