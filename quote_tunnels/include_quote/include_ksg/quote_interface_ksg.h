#if !defined(MY_QUOTE_INTERFACE_KSG_H_)
#define MY_QUOTE_INTERFACE_KSG_H_

#include "quote_datatype_ksg.h"
...
public:
     ...
     */
    void SetQuoteDataHandler(boost::function<void(const CKSG_DepthMarketDataField *)> quote_handler);
...
#endif  //MY_QUOTE_INTERFACE_KSG_H_
