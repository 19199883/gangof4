#if !defined(MY_QUOTE_INTERFACE_SGIT_H_)
#define MY_QUOTE_INTERFACE_SGIT_H_
...
public:
    ...
    /**
     * @param quote_handler 行情处理的函数对象。飞鼠接口
     */
    void SetQuoteDataHandler(boost::function<void(const struct SGIT_Depth_Market_Data_Field *)> quote_handler);
...
#endif  //MY_QUOTE_INTERFACE_SGIT_H_
