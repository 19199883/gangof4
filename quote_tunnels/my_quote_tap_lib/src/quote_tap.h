 ...
 * 		quote_tap.h
 *
 * 		class of package the TapApi interface
 *
...
typedef list<TapAPIContract*> listcn_t;
...
private:
    ...
    listex_t exchange_list_;
    listcm_t commodity_list_;
    listcn_t contract_list_;

    /* 包装函数，方便线程调用 */
    void req_login(int wait_seconds);
    void qry_contract_by_exchange();
    ...
    QuoteDataSave<TapAPIQuoteWhole_MY> *p_save_tap_;
