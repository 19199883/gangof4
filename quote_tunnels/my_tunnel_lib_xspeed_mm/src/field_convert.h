...
public:
    // 转换成XSpeed字段取值
    inline static int GetXSpeedBuySell(char direction);
    inline static int GetXSpeedOCFlag(char open_close);
    inline static int GetXSpeedHedgeType(char hedge_flag);
    inline static int GetXSpeedPriceType(char price_type);
    inline static int GetXSpeedOrderProperty(char order_type);

    // 从XSpeed转换会MY协议取值
    inline static char GetMYOrderStatus(short OrderStatus);
    inline static char GetMYHedgeType(int HedgeFlag);
...
int XSpeedFieldConvert::GetXSpeedBuySell(char direction)
{
...
int XSpeedFieldConvert::GetXSpeedOCFlag(char open_close)
{
    switch (open_close)
    {
        case MY_TNL_D_OPEN:
...
int XSpeedFieldConvert::GetXSpeedHedgeType(char hedge_flag)
{
...
int XSpeedFieldConvert::GetXSpeedPriceType(char price_type)
{
...
int XSpeedFieldConvert::GetXSpeedOrderProperty(char order_property)
{
...
char XSpeedFieldConvert::GetMYOrderStatus(short OrderStatus)
{
    switch (OrderStatus)
    {
        //撤单成功 -->  已经撤销
...
char XSpeedFieldConvert::GetMYHedgeType(int HedgeFlag)
{
    switch (HedgeFlag)
    {
...
char XSpeedFieldConvert::GetMYPriceType(char PriceType)
{
    switch (PriceType)
    {
