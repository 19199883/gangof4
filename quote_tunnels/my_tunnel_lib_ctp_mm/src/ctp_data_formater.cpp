...
std::string CTPDatatypeFormater::ToString(const CThostFtdcOrderField* pdata)
{
    ...
    ss << indent_string << "ZCETotalTradedVolume=" << pdata->ZCETotalTradedVolume << endl;
    ss << indent_string << "IsSwapOrder=" << pdata->IsSwapOrder << endl;
...
std::string CTPDatatypeFormater::ToString(const CThostFtdcInputForQuoteField* pdata)
{
    char buf[2048];

    if (pdata)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcSettlementInfoField\n"
            "    BrokerID=%s\n"
            "    InvestorID=%s\n"
            "    InstrumentID=%s\n"
            "    ForQuoteRef=%s\n"
    ...
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcSettlementInfoField <null>");
    }

    return buf;
}

std::string CTPDatatypeFormater::ToString(const CThostFtdcInputQuoteField* pdata)
{
    char buf[2048];

    if (pdata)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcInputQuoteField\n"
            "    BrokerID=%s\n"
            "    InvestorID=%s\n"
            "    InstrumentID=%s\n"
            "    QuoteRef=%s\n"
    ...
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcInputQuoteField <null>");
    }

    return buf;
}

std::string CTPDatatypeFormater::ToString(const CThostFtdcInputQuoteActionField* pdata)
{
    char buf[2048];

    if (pdata)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcInputQuoteActionField\n"
            "    InvestorID=%s\n"
            "    QuoteActionRef=%d\n"
            "    QuoteRef=%s\n"
            "    RequestID=%d\n"
    ...
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcInputQuoteActionField <null>");
    }

    return buf;
}

std::string CTPDatatypeFormater::ToString(const CThostFtdcQryQuoteField* pdata)
{
    char buf[2048];

    if (pdata)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcQryQuoteField\n"
            "    BrokerID=%s\n"
            "    InvestorID=%s\n"
            "    InstrumentID=%s\n"
            "    ExchangeID=%s\n"
            ...
            pdata->ExchangeID,
            pdata->QuoteSysID,
            pdata->InsertTimeStart,
            pdata->InsertTimeEnd);
    }
    else
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcQryQuoteField <null>");
    }

    return buf;
}

std::string CTPDatatypeFormater::ToString(const CThostFtdcQuoteField* pdata)
{
    char buf[2048];

    if (pdata)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcQuoteField\n"
            "    BrokerID=%s\n"
            "    InvestorID=%s\n"
            "    InstrumentID=%s\n"
            "    QuoteRef=%s\n"
            ...
            pdata->TraderID,
            pdata->InstallID,
            pdata->NotifySequence,
            pdata->OrderSubmitStatus,
            pdata->TradingDay,
            pdata->SettlementID,
            pdata->QuoteSysID,
            pdata->InsertDate,
            ...
            pdata->StatusMsg,
            pdata->ActiveUserID,
            pdata->BrokerQuoteSeq,
            pdata->AskOrderRef,
            pdata->BidOrderRef);
    }
    else
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcQuoteField <null>");
    }

    return buf;
}

std::string CTPDatatypeFormater::ToString(const CThostFtdcQuoteActionField* pdata)
{
    char buf[2048];

    if (pdata)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcQuoteActionField\n"
            "    BrokerID=%s\n"
            "    InvestorID=%s\n"
            "    QuoteActionRef=%d\n"
            "    QuoteRef=%s\n"
    ...
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcQuoteActionField <null>");
    }

    return buf;
}

std::string CTPDatatypeFormater::ToString(const CThostFtdcForQuoteRspField* pdata)
{
    char buf[2048];

    if (pdata)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcForQuoteRspField\n"
            "    TradingDay=%s\n"
            "    InstrumentID=%s\n"
            "    ForQuoteSysID=%s\n"
            "    ForQuoteTime=%s\n"
    ...
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcForQuoteRspField <null>");
    }
...
std::string CTPDatatypeFormater::ToString(const CThostFtdcInstrumentField *p)
{
    ...
    if (p)
    {
        snprintf(buf, sizeof(buf), "structName=CThostFtdcInstrumentField\n"
            ...
            InvalidToZeroD(p->LongMarginRatio),                //多头保证金率
            InvalidToZeroD(p->ShortMarginRatio)                //空头保证金率
            );
    }
    else
    {
